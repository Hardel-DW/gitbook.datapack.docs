...
### <mark style="color:orange;">Dark Elven & Twilight Of Yggdrasil</mark>
...
### <mark style="color:orange;">The Authentic Asflors Swords & Fake Asflors Sword</mark>
...
### <mark style="color:orange;">Ran's Apple</mark>
...
### <mark style="color:orange;">Reva (Pet)</mark>

A unique companion obtained by completing the lore quest within the tragic realm of Helheim. Reva grants its owner a special beneficial effect. (More details on the Helheim page)

{% content-ref url="reva-pet.md" %}
[reva-pet.md](reva-pet.md)
{% endcontent-ref %}
