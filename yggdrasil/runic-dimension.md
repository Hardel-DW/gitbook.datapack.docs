...
{% step %}
Obtain the Runic Island Entrance Key

As part of the Asflors quest :

1. Locate the unique house with a green roof within the Asflors village.
2. Search the roof's foliage for a hidden chest. This chest contains both a treasure map leading to the Runic Island and the Rune of Breaking (the entrance key).
{% endstep %}

{% step %}
Travel to the Runic Island:
...
{% step %}
Enter the Runic Island

Use the Rune of Breaking on the sealed main entrance door.
{% endstep %}
...
> _The key is related to the Asflors quest but not strictly necessary for reaching the Runic Dimension portal._
{% endstep %}
